    ...
    public void validate(@NotNull PsiElement psiElement, @NotNull final AnnotationHolder annotationHolder) {
        traversal.getKeyNameIfKey(psiElement).ifPresent(keyName -> {
            ...
            if (pathResolver.childOfContact(keyObject)) {
                unknownKeyValidator.validate(keyName, SwaggerFields.contact(), psiElement, annotationHolder);
                ...
                unknownKeyValidator.validate(keyName, SwaggerFields.license(), psiElement, annotationHolder);
                ...
                unknownKeyValidator.validate(keyName, SwaggerFields.responses(), psiElement, annotationHolder);
